...
class LisMovieAdapter(private val listItems: List<Movie>?, private val context: Context?, private val mListener: OnItemClicked)
    : RecyclerView.Adapter<LisMovieAdapter.ViewHolder>() {
